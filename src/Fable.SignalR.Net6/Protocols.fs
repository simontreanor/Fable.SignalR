...
module Protocol =
    open Fable.SignalR.Net6.Shared
    ...
    module HubRecords =
        ...
        module InvocationMessage =
            ...
            let inline create<'T> headers invocationId target (args: ResizeArray<'T>) streamIds =
                { ``type`` = MessageType.Invocation
                  ...
                  streamIds = streamIds }
                |> validate
                |> unbox<Fable.SignalR.Net6.Messages.InvocationMessage<'T>>
        ...
        module StreamInvocationMessage =
            let inline create<'T> headers invocationId target (args: ResizeArray<'T>) streamIds =
                { ``type`` = MessageType.StreamInvocation
                  ...
                  arguments = args
                  streamIds = streamIds }
                |> unbox<Fable.SignalR.Net6.Messages.StreamInvocationMessage<'T>>
        ...
        module StreamItemMessage =
            ...
            let inline create<'T> headers invocationId (item: 'T) =
                { ``type`` = MessageType.StreamItem
                  ...
                  item = item } 
                |> validate
                |> unbox<Fable.SignalR.Net6.Messages.StreamItemMessage<'T>>
        ...
        module CompletionMessage =
            ...
            let inline create<'T> headers invocationId error (result: 'T option) =
                { ``type`` = MessageType.Completion
                  ...
                  result = result } 
                |> validate
                |> unbox<Fable.SignalR.Net6.Messages.CompletionMessage<'T>>
        ...
        module PingMessage =
            let inline create () = 
                ...
                |> unbox<Fable.SignalR.Net6.Messages.PingMessage>
        ...
        module CloseMessage =
            let inline create error allowReconnect =
                ...
                |> unbox<Fable.SignalR.Net6.Messages.CloseMessage>
        ...
        module CancelInvocationMessage =
            let inline create headers invocationId =
                { ``type`` = MessageType.CancelInvocation
                  headers = headers
                  invocationId = invocationId } 
                |> unbox<Fable.SignalR.Net6.Messages.CancelInvocationMessage>
    ...
    module MsgPack =
        ...
        open Fable.SignalR.Net6.Shared.MsgPack
