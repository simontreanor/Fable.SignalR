...
module Feliz =
    type Hub<'ClientApi,'ServerApi> = Fable.React.IRefValue<Fable.SignalR.Net6.Hub<'ClientApi,'ServerApi>>
    ...
    type React with
        static member inline useSignalR<'ClientApi,'ServerApi> (config: Hub.Config<'ClientApi,'ServerApi>, ?dependencies: obj []) =
            ...
            React.useRef(connection.current :> Fable.SignalR.Net6.Hub<'ClientApi,'ServerApi>)
        ...
        static member inline useSignalR<'ClientApi,'ClientStreamApi,'ServerApi,'ServerStreamApi> 
            ...
            React.useRef(connection.current :> Fable.SignalR.Net6.StreamHub.ServerToClient<'ClientApi,'ClientStreamApi,'ServerApi,'ServerStreamApi>)
        ...
        static member inline useSignalR<'ClientApi,'ClientStreamApi,'ServerApi> 
            ...
            React.useRef(connection.current :> Fable.SignalR.Net6.StreamHub.ClientToServer<'ClientApi,'ClientStreamApi,'ServerApi>)
        ...
        static member inline useSignalR<'ClientApi,'ClientStreamFromApi,'ClientStreamToApi,'ServerApi,'ServerStreamApi> 
            ...
            React.useRef(connection.current :> Fable.SignalR.Net6.StreamHub.Bidrectional<'ClientApi,'ClientStreamFromApi,'ClientStreamToApi,'ServerApi,'ServerStreamApi>)
